                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body">
                                    <table id="tabletools" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($languages as $language) { 
                                                ...
                                                <tr data-tid="<?= $language->ID ?>">
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/languages/edit/<?= $language->ID ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                        <a  class="delete" id="delete<?= $language->ID ?>" data-id="<?= $language->ID ?>" data-link="<?= base_url() ?>admin/languages/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
                                     ...
                                     <a href="<?=base_url()?>admin/languages/add" class="btn addBtn pull-right">ახალი ენის დამატება</a>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
