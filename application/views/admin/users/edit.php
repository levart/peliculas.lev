                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">მომხმარებლის რედაქტირება</h4>
                                </div>
                                <div class="panel-body pb0">
                                    
                                    <form id="edit" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/users/editdata/">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            ...
                                                            <input type="text" placeholder="სახელი" name="firstname" class="form-control" value="<?= $base->firstname ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <span class="input-group-addon"><i class="icomoon-icon-user s16"></i> </span>
                                                            <input type="text" placeholder="გვარი" name="lastname" class="form-control" value="<?= $base->lastname ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="page" class="control-label col-sm-2">პირადი ნომერი</label>
                                            <div class="col-sm-10">
                                                <input id="page" name="personalID" class=" form-control" value="<?= $base->personalID ?>"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name_geo" class="control-label col-sm-2">ელ.ფოსტა</label>
                                            <div class="col-sm-10">
                                                <input id="email" name="email" class=" form-control" value="<?= $base->email ?>" type="email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name_eng" class="control-label col-sm-2">ტელეფონი</label>
                                            <div class="col-sm-10">
                                                <input id="phone" name="phone" class="form-control" value="<?= $base->phone ?>" type="tel">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="desc_geo" class="control-label col-sm-2">დაბადების თარიღი</label>
                                            <div class="col-sm-10">
                                                <input id="birth" class="form-control" name="birth" value="<?= $base->birth ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
