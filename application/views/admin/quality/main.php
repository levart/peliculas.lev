                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body">
                                    <table id="tabletools" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($qualities as $quality) { 
                                                ...
                                                <tr data-tid="<?= $quality->ID ?>">
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/quality/edit/<?= $quality->ID ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                        <a  class="delete" id="delete<?= $quality->ID ?>" data-id="<?= $quality->ID ?>" data-link="<?= base_url() ?>admin/quality/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
                                     ...
                                     <a href="<?=base_url()?>admin/quality/add" class="btn addBtn pull-right">ახალი ხარისხის დამატება</a>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
