                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">ხარისხის დამატება</h4>
                                </div>
                                <div class="panel-body pb0">
                                   
                                    <form id="add" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/quality/adddata/" enctype="multipart/form-data">
