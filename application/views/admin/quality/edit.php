                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">ხარისხის რედაქტირება</h4>
                                </div>
                                <div class="panel-body pb0">
                                   
                                    <form id="edit" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/quality/editdata/" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <div class="input-group input-icon">
                                                        <input type="text" name="name" class="form-control" value="<?= $quality->name ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
