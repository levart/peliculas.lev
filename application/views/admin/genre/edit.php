                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">ჟანრის რედაქტირება</h4>
                                </div>
                                <div class="panel-body pb0">
                                   
                                    <form id="edit" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/genre/editdata/" enctype="multipart/form-data">
