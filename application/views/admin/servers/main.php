                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body">
                                    <table id="tabletools" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($servers as $server) { 
                                                ...
                                                <tr data-tid="<?= $server->ID ?>">
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/servers/edit/<?= $server->ID ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                        <a  class="delete" id="delete<?= $server->ID ?>" data-id="<?= $server->ID ?>" data-link="<?= base_url() ?>admin/servers/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
                                     ...
                                     <a href="<?=base_url()?>admin/servers/add" class="btn addBtn pull-right">ახალი სერვერის დამატება</a>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
