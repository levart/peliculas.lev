                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">რეჟისორის რედაქტირება</h4>
                                </div>
                                <div class="panel-body pb0">
                                   
                                    <form id="edit" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/directors/editdata/" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-lg-2 col-md-3  control-label">ნამდვილი სახელი</label>
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="real_name" class="form-control" value="<?= $director->real_name ?>">
                                                        </div>
                                                    </div>
                                              </div> 
                                        </div>
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="date" name="birthdate" class="form-control" value="<?= $director->birthdate ?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="birth_loc" class="form-control" value="<?= $director->birth_loc ?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="proff" class="form-control" value="<?= $director->proff ?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="height" class="form-control" value="<?= $director->height ?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="raiting" class="form-control" value="<?= $director->raiting ?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        </div>
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <textarea name="biography" class="form-control" rows="8"><?= $director->biography ?></textarea>
                                                        </div>
                                                    </div>
                                              </div>
