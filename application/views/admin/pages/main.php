                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body">
                                        ...
                                        <tbody>
                                            <?php foreach ($bases as $base) { ?>
                                                <tr data-tid="<?= $base->id ?>">
                                                    ...
                                                    <td><?= $base->page ?></td>
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/pages/edit/<?= $base->id ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                       
                                                        <a  class="delete" id="delete<?= $base->id ?>" data-id="<?= $base->id ?>" data-link="<?= base_url() ?>admin/pages/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
                                    ...
                                    <a href="<?=base_url()?>admin/pages/add" class="btn addBtn pull-right">ახალი გვერდის დამატება</a>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
