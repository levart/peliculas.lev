                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body">
                                    <a href="<?=base_url()?>admin/movies/add" class="btn btn-primary  pull-left">ახალი ფილმის დამატება</a>
                                        ...
                                        <tbody>
                                            <?php foreach ($movies as $movie) { ?>
                                                <tr data-tid="<?= $movie->ID ?>">
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/movies/edit/<?= $movie->ID ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                        <a  class="delete" id="delete<?= $movie->ID ?>" data-id="<?= $movie->ID ?>" data-link="<?= base_url() ?>admin/movies/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
