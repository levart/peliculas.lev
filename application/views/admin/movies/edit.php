                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">ფილმის რედაქტირება</h4>
                                </div>
                                <div class="panel-body pb0">
                                    ...
                                    <form id="add" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/movies/adddata/" enctype="multipart/form-data">
                                        <input type="hidden" name="id" id="id" value="<?=$movies->ID?>" />
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-10 col-xs-10">
                                                        ...
                                                        <input id="basic-datepicker" type="text" class="form-control" name="year"  value="<?=$movies->year?>">
                                              ...
                                              <div class="col-lg-8 col-md-8">
                                                  <div class="row">
                                                      <div class="col-lg-6 col-md-6 col-sm-10 col-xs-10">
                                                           ...
                                                           <div class="input-group input-icon">
                                                               <input type="text" class="form-control" name="imdb" placeholder="IMDB" value="<?=$movies->imdb?>">
                                                               <span class="help-block text-center">IMDB</span>
                                                          </div>
                                                      </div>
                                                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                          <div class="input-group input-icon">
                                                              <input type="text" class="form-control" name="imdb_link" placeholder="IMDB link" value="<?=$movies->imdb_link?>">
                                                  ...
                                                  <select class="form-control director"  name="director" id="director">
                                                      ...
                                                      <?php 
                                                          foreach ($directors as $director) {  ?>
                                                            ...
                                                            <option value="<?=$director->ID?>" <?php if($director->ID==$movies->director_id){ echo "selected";}?>><?=$director->name?></option>
                                      ...
                                      <div class="form-group">
                                                    ...
                                                    <?php 
                                                        foreach ($genres as $genre) {  ?>
                                                          ...
                                                          <option value="<?=$genre->ID?>"   
                                                                  ...
                                                                  <?php $mm = explode(",",$movies->genre_id);
                                                                    foreach ($mm as $key ) {
                                                                        if ($key==$genre->ID) {
                                                                         echo "selected";
                                                                        }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                   <input type="text"  data-role="tagsinput" name="producer" value="<?=$movies->producers?>">
                                                </div>
                                              </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                               <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <select class="form-control select2" multiple name="actors" id="actor">
                                                    <?php 
                                                        foreach ($actors as $actor) {  ?>
                                                          ...
                                                          <option value="<?=$actor->ID?>"
                                                                  ...
                                                                  <?php $ac = explode(",",$movies->actor_id);
                                                                    foreach ($ac as $act ) {
                                                                        if ($act==$actor->ID) {
                                                                         echo "selected";
                                                                        }
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="slogan" class="form-control" value="<?=$movies->slogan?>">
                                                        </div>
                                                    </div>
                                              </div>
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group">
                                                          ...
                                                          <input type="number" class="form-control" name="budget" value="<?=$movies->budget?>">
                                         ...
                                         <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                         <div class="input-group">
                                                          <span class="input-group-addon">$</span>
                                                          <input type="number" class="form-control" name="box_office" value="<?=$movies->box_office?>">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            ...
                                                            <input type="text" class="form-control" name="trailer" value="<?=$trailer[0]->url;?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <textarea name="descrip" class="form-control" rows="8"><?=$movies->descrip?></textarea>
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" class="form-control" name="rates" value="<?=$movies->rates?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input name="img" id="img"  type="text" class="form-control" value="<?=$movies->img?>">
