                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">ბლოგის რედაქტირება</h4>
                                </div>
                                <div class="panel-body pb0">
                                   
                                    <form id="edit" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/blog/editdata/" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <div class="input-group input-icon">
                                                        <input type="text" name="blog" class="form-control" value="<?= $blog->blog ?>" id="blog">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-lg-2 col-md-3  control-label">სათაური</label>
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="name" class="form-control" value="<?= $blog->name ?>" id="name">
                                                        </div>
                                                    </div>
                                              </div> 
                                        </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                                <input type="text" name="descrip" class="form-control" value="<?= $blog->descrip ?>" id="descrip">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                        <textarea name="text" class="form-control"  id="text"><?= $blog->text ?></textarea>
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        ...
                                                        <?php 
                                                          ...
                                                          <option value="<?=$cat->ID;?>"  <?php if($cat->ID== $blog->cat){echo "selected";}?>><?=$cat->title;?></option>
