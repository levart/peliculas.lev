                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body">
                                    <table id="tabletools" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($blogs as $blog) { ?>
                                                <tr data-tid="<?= $blog->ID ?>">
                                                    ...
                                                    <td><img src="<?= $blog->img ?>" height="70"/> </td>
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/blog/edit/<?= $blog->ID ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                        <a  class="delete" id="delete<?= $blog->ID ?>" data-id="<?= $blog->ID ?>" data-link="<?= base_url() ?>admin/blog/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
                                     ...
                                     <a href="<?=base_url()?>admin/blog/add" class="btn addBtn pull-right">ახალი ბლოგის დამატება</a>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
