                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">სლაიდერის რედაქტირება</h4>
                                </div>
                                <div class="panel-body pb0">
                                   
                                    <form id="edit" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/slider/editdata/" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group">
                                              ...
                                              <label for="" class="col-lg-2 col-md-3  control-label">ქოვერის სურათი</label>
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input name="cover_img" id="img"  type="text" class="form-control" value="<?=$slider->cover_img?>">
                                        ...
                                        <div class="form-group">
                                               ...
                                               <label for="" class="col-lg-2 col-md-3  control-label">ტრეილერის ლინკი</label>
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="trailer_link" class="form-control" value="<?=$slider->trailer_link?>">
                                                        </div>
                                                    </div>
                                              </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <input type="text" name="film_link" class="form-control" value="film_link">
                                                        </div>
                                                    </div>
                                              </div>
