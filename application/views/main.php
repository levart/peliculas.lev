            ...
            <div class="contentor" id="contentor"> 
                ...
                <div class="home-page clearfix" id="home-page"> 
                    ...
                    <div style="    padding-top: 5px;" id="MainContent">
                        ...
                        <div style="display:none;" class="playScript"> (function($) {
                            ...
                            $.each($('.mv_static_slider'),function(){
                            ...
                            jcarousel.parents('.mv_videos_container').find('.mv_fluid_vid_slider_arrow.right_arrow')

                            .on('click',function(event,carousel){

                            //console.log($(this.carousel.jcarousel.last()));
                            ...
                            var jcarousel = $('.mv_static_slider');
                            ...
                            console.log(singleChildMargin);

                            var width = childrenCount * (singleChildMargin+singleChildWidth);

                            jcarousel.find('.mv_videos_container_fluid').css('width', width + 'px');

                            jcarousel.find('.mv_videos_container_fluid').children().last().not('.clear').addClass('last')
                            ...
                            console.log($(this).parents('.mv_static_slider').find('.mv_fluid_vid_slider_arrow.right_arrow'));
