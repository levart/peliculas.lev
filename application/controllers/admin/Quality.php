...
class quality extends CI_Controller {
    ...
    public function index() {
        ...
        $data['qualities'] = $this->quality_model->getQualityData();
            ...
            $this->load->view('admin/quality/main',$data);
    ...
    public function edit($id) {
        ...
        if ($this->session->userdata('id')) {
            $data['quality'] = $this->quality_model->getQuality($this->id);
            $this->load->view('admin/quality/edit',$data);
        } else {
            redirect('/');
        }
    }
    ...
    public function editdata() {
        ...
        if ($this->session->userdata('id')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $query = $this->quality_model->editQuality();
    ...
    public function delete() {
        ...
        if ($this->quality_model->deleteQuality($this->actorid) == true) {
            return true;
        } else {
            return FALSE;
        }
    ...
    public function add() {
        ...
        if ($this->session->userdata('is_admin_login')) {
            ...
            $this->load->view('admin/quality/add');
        } else {
            redirect('/');
        }
    }
    ...
    public function adddata() {
        ...
        if ($this->session->userdata('is_admin_login')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $query = $this->quality_model->addQuality ();
            }
