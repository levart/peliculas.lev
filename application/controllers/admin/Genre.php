...
class genre extends CI_Controller {
    ...
    public function index() {
        ...
        $data['genres'] = $this->genre_model->getActorData();

            $this->load->view('admin/genre/main',$data);
    ...
    public function edit($userid) {
        ...
        if ($this->session->userdata('id')) {
            $data['genre'] = $this->genre_model->getActor($this->userid);
            $this->load->view('admin/genre/edit',$data);
        } else {
            redirect('/');
        }
    }
    ...
    public function editdata() {
        ...
        if ($this->session->userdata('id')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $query = $this->genre_model->editActor();
    ...
    public function delete() {
        ...
        if ($this->genre_model->deleteActor($this->actorid) == true) {
            return true;
        } else {
            return FALSE;
        }
    ...
    public function add() {
        ...
        if ($this->session->userdata('is_admin_login')) {
            ...
            $this->load->view('admin/genre/add');
        } else {
            redirect('/');
        }
    }
    ...
    public function adddata() {
        ...
        if ($this->session->userdata('is_admin_login')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $query = $this->genre_model->addactor ();
            }
